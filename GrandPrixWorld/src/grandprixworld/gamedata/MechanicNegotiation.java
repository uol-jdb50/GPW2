 ...
 * @author Josh Brookes
 */
public class MechanicNegotiation {
    ...
    public MechanicNegotiation(ChiefMechanic chiefMech, Team team, int salary, int racebonus, int champbonus, int finalseason) {
    ...
    public void calculateTargets() {
        Random r = new Random();
        targetSalary = (int) (chiefMech.salary  * ((r.nextDouble() / 25.0) + 1));
        targetRaceBonus = (int) (chiefMech.racebonus  * ((r.nextDouble() / 40.0) + 1));
        targetChampBonus = (int) (chiefMech.champbonus  * ((r.nextDouble() / 30.0) + 1));
