 ...
 * @author Josh Brookes
 */
public class TechnicalNegotiation {
    ...
    public TechnicalNegotiation(TechnicalDirector techDir, Team team, int salary, int racebonus, int champbonus, int finalseason) {
    ...
    public void calculateTargets() {
        Random r = new Random();
        targetSalary = (int) (techDir.salary  * ((r.nextDouble() / 25.0) + 1));
        targetRaceBonus = (int) (techDir.racebonus  * ((r.nextDouble() / 40.0) + 1));
        targetChampBonus = (int) (techDir.champbonus  * ((r.nextDouble() / 30.0) + 1));
